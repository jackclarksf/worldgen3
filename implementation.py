...
#TASK - WORK OUT NEW INPUT/OUTPUT. WORKS BY FEEDING IN LAND/WATER AND SCOUT START AND CITY END AND OUTPUTTING PATH
...
#NEXT, GENERATE A WATER LIST AND INSERT THAT AS WALLS
